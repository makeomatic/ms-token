...
class TokenManager {
  constructor(opts) {
     ...
     */
    this.create = require('./actions/create');
     ...
     */
    this.regenerate = require('./actions/regenerate');
     ...
     * See README for more details
     */
    this.remove = require('./actions/remove');
